package com.business.common.gen.service.impl;

import com.business.common.gen.dao.GenMapper;
...
import com.common.util.GenUtils;
import com.common.util.VelocityInitializer;
import com.common.util.StringUtils ;
import com.framework.config.GenConfig;
 ...
 */
@Service
public class GenService implements IGenSerivce {
    ...
    public byte[] generatorCode(String tableName)  {
        ...
        if (tableInfo == null) {
            throw new BusinessException("系统中不存在该表");
        }
        // 查询列信息
